...
def build_finetune_model(
    base_model, dropout, num_classes, ckpt="./checkpoints/checkpoint.hdf5"
):
...
finetune_model = build_finetune_model(base_model, dropout=dropout, num_classes=42)
...
finetune_model = build_finetune_model(base_model, dropout=0.4, num_classes=42)
